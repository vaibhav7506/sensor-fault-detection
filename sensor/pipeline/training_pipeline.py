...
class TrainPipeline:
    ...
    def __init__(self, source_path=None):
        ...
        self.s3_sync = S3Sync() if os.getenv("ENABLE_S3_SYNC", "false").lower() == "true" else None
    ...
    def start_data_ingestion(self)->DataIngestionArtifact:
        try:
            ...
            data_ingestion = DataIngestion(data_ingestion_config=self.data_ingestion_config, source_path=self.source_path)
